        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-gray-600">
              Empowering tech professionals with expert mentorship, resources, and guidance for career growth.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link href="/mentors" className="text-base text-gray-600 hover:text-gray-900">
                  Find a Mentor
                </Link>
              </li>
              <li>
                <Link href="/resources" className="text-base text-gray-600 hover:text-gray-900">
                  Resources
                </Link>
              </li>
              <li>
